(function (c, f, g) {
  ...
  j =
    ...
    /msie 7./i.test(f.navigator.appVersion) &&
    f.ActiveXObject;
  h = null;
  m = function () {
    var b, a;
  ...
  k = (function () {
    ...
    b.prototype.preventScrolling = function (a, b) {
      this.isActive &&
        ("DOMMouseScroll" === a.type
          ? (("down" === b && 0 < a.originalEvent.detail) ||
              ("up" === b && 0 > a.originalEvent.detail)) &&
            a.preventDefault()
          : "mousewheel" === a.type &&
            a.originalEvent &&
            a.originalEvent.wheelDelta &&
            (("down" === b && 0 > a.originalEvent.wheelDelta) ||
              ("up" === b && 0 < a.originalEvent.wheelDelta)) &&
            a.preventDefault());
    };
      ...
      this.events = {
        ...
        drag: function (b) {
          ...
          a.contentScrollTop >= a.maxScrollTop
            ...
            : 0 === a.contentScrollTop && a.$el.trigger("scrolltop");
          return !1;
        },
        up: function () {
          a.isBeingDragged = !1;
          ...
          a.doc
            .unbind("mousemove", a.events.drag)
            .unbind("mouseup", a.events.up);
          return !1;
        },
        resize: function () {
          a.reset();
        ...
        scroll: function (b) {
          a.isBeingDragged ||
            ...
            a.slider.css({ top: a.sliderTop }),
            null != b &&
              (a.contentScrollTop >= a.maxScrollTop
                ? (a.options.preventPageScrolling &&
                    a.preventScrolling(b, "down"),
                  a.$el.trigger("scrollend"))
                : 0 === a.contentScrollTop &&
                  (a.options.preventPageScrolling &&
                    a.preventScrolling(b, "up"),
                  a.$el.trigger("scrolltop"))));
        },
        wheel: function (b) {
          if (null != b)
            return (a.sliderY += -b.wheelDeltaY || -b.delta), a.scroll(), !1;
        },
      };
    };
    b.prototype.addEvents = function () {
      ...
      this.pane
        .bind("mousedown", a.panedown)
        .bind("mousewheel DOMMouseScroll", a.wheel);
    ...
    b.prototype.removeEvents = function () {
      ...
      this.pane.unbind();
      this.content
        .unbind("scroll mousewheel DOMMouseScroll touchmove", a.scroll)
        .unbind("keydown", a.keydown)
        .unbind("keyup", a.keyup);
    };
    b.prototype.generate = function () {
      ...
      d = i.sliderClass;
      a = i.contentClass;
      !this.$el.find("" + c).length &&
        !this.$el.find("" + d).length &&
        this.$el.append(
          '<div class="' + c + '"><div class="' + d + '" /></div>'
        );
    ...
    b.prototype.reset = function () {
      ...
      d = g + e + d;
      e = Math.round((d / b) * d);
      e < this.options.sliderMinHeight
        ? (e = this.options.sliderMinHeight)
        : null != this.options.sliderMaxHeight &&
          e > this.options.sliderMaxHeight &&
          (e = this.options.sliderMaxHeight);
      ...
      this.pane.show();
      this.isActive = !0;
      this.pane.outerHeight(!0) >= a.scrollHeight && "scroll" !== f
        ? (this.pane.hide(), (this.isActive = !1))
        : this.el.clientHeight === a.scrollHeight && "scroll" === f
        ? this.slider.hide()
        : this.slider.show();
      return this;
    };
    ...
    b.prototype.scrollTo = function (a) {
      ...
      a > this.maxSliderTop &&
        ...
        (this.sliderY = a *= this.maxSliderTop),
        this.scroll());
      return this;
    };
  ...
  c.fn.nanoScroller = function (b) {
    return this.each(function () {
      var a;
      if (!(a = this.nanoscroller))
        (a = c.extend({}, l)),
          b && "object" === typeof b && (a = c.extend(a, b)),
          (this.nanoscroller = a = new k(this, a));
