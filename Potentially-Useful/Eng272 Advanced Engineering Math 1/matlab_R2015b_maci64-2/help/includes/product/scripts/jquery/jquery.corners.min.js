...
jQuery.fn.corners = function (C) {
  ...
  function U(f, a, d, c) {
    ...
    if (d - a.sizey < 0) {
      try {
        console.error(
          "%s padding is %ipx for %ipx corner:",
          c ? "top" : "bottom",
          d,
          a.sizey,
          f
  ...
  function D(b) {
    try {
      ...
      if (
        d.match(/^(transparent|rgba\(0,\s*0,\s*0,\s*0\))$/i) &&
        b.parentNode
      ) {
  ...
  function P(f, d, h) {
    var e = Array(
      parseInt("0x" + f.substring(1, 3)),
      parseInt("0x" + f.substring(3, 5)),
      parseInt("0x" + f.substring(5, 7))
    );
    var c = Array(
      parseInt("0x" + d.substring(1, 3)),
    ...
    for (h = 1; h <= z.sizey; h++) {
      ...
      for (f = 1; f <= v; f++) {
        if (f == 1) {
          ...
          if (f == v) {
            t =
              Math.sqrt(1 - Math.pow((z.sizex - c - f + 1) / z.sizex, 2)) *
              z.sizey;
            u = 1 - (1 - (t - (z.sizey - h))) * (1 - (b - w)) * 0.5;
          } else {
            q =
              Math.sqrt(1 - Math.pow((z.sizex - c - f) / z.sizex, 2)) * z.sizey;
            t =
              Math.sqrt(1 - Math.pow((z.sizex - c - f + 1) / z.sizex, 2)) *
              z.sizey;
            u = (t + q) * 0.5 - (z.sizey - h);
  ...
  function G(c, o, l, h) {
    ...
    for (var b = 0; b < o.sizey; b++) {
      ...
      if (h) {
        k.style.borderWidth =
          "0 " + (o.tr ? n : 0) + "px 0 " + (o.tl ? n : 0) + "px";
      } else {
        k.style.borderWidth =
          "0 " + (o.br ? n : 0) + "px 0 " + (o.bl ? n : 0) + "px";
      }
