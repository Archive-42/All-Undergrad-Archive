...
function writeDocFeedbackSurveyLink() {
  ...
  if (queryexpression.indexOf("help/ja_JP/") >= 0) {
    ...
    str_no = "&#x3044;&#x3044;&#x3048;";
    str_helpful =
      '<span style="font-size:1.2em">&#x3053;&#x306e;&#x60c5;&#x5831;&#x306f;&#x5f79;&#x306b;&#x7acb;&#x3061;&#x307e;&#x3057;&#x305f;&#x304b;&#xff1f;</span>';
  } else if (queryexpression.indexOf("help/zh_CN/") >= 0) {
    // Chinese
    str_yes = "&#x662F;";
    str_no = "&#x5426;";
    str_helpful =
      '<span style="font-size:1.2em">&#x8FD9;&#x91CC;&#x7684;&#x8BAE;&#x9898;&#x5BF9;&#x4F60;&#x6709;&#x5E2E;&#x52A9;&#x5417;&#xFF1F;</span>';
  } else {
    // Default to English
    str_yes = "Yes";
    str_no = "No";
  ...
  survey_url_yes =
    "http://www.customersat3.com/TakeSurvey.asp?si=YU2FDmNEifg%3D&SF=" +
    queryexpression +
    "-YES";
  survey_url_no =
    "http://www.customersat3.com/TakeSurvey.asp?si=YU2FDmNEifg%3D&SF=" +
  ...
  code =
    '<div style="padding-right:10px" class="feedbackblock">' +
    "<strong>" +
    str_helpful +
    '</strong> <input type="button" value="' +
    str_yes +
    '" onClick="openWindow(\'' +
    survey_url_yes +
    "',850,680, 'scrollbars=yes,resizable=yes'); return false;\"/>" +
    "&nbsp;&nbsp;" +
...
$(document).ready(function () {
  ...
  $(
    '#doc_center_content img:not(".animated-image, [usemap]"), #content_container2 img:not(".animated-image, [usemap]")'
  ).each(function () {
    checkImage($(this));
  });

  $(
    "#doc_center_content img.animated-image, #content_container2 img.animated-image"
  ).each(function () {
...
function prepareEltForExpansion(elt) {
  if (elt.hasClass("expand")) {
    doExpandNestedParent(elt);
...
function checkAndCollapseBreadCrumb(breadcrumb) {
  ...
  var collapsibleBreadcrumbChildren = $(
    ".breadcrumbs_collapsed:last"
  ).nextAll();
...
function checkAndExpandBreadCrumb(breadcrumb) {
  ...
  var expandableBreadcrumbChildren = $(
    $(".breadcrumbs_collapsed").get().reverse()
  );
...
function resetBreadcrumbCss(breadcrumb) {
  breadcrumb
    .find(".breadcrumbs_outer")
    .css({ width: "auto", "white-space": "normal", overflow: "auto" });
}
...
function setBreadcrumbCss(breadcrumb) {
  ...
  breadcrumb
    .find(".breadcrumbs_outer")
    .css({
      width: availableBreadcrumbWidth,
      "white-space": "nowrap",
      overflow: "hidden",
    });
}
...
function addBreadcrumbEventHandler(elem) {
  elem
    .bind("mouseenter.breadcrumb", function () {
...
function getTocEl() {
  var toc_container_wrapper = $(
    '<div class="toc_container_wrapper" tabindex="0" style="display:none;"></div>'
  );
  var toc_container_header = $(
    '<div class="toc_container_header">Table of Contents<div class="toc_close_icon"></div></div>'
  );
...
function setTocSize(toc_container_wrapper) {
  if (toc_container_wrapper) {
    ...
    toc_container_wrapper
      .find(".toc_container:first")
      .css("max-height", $(window).height() * (2 / 3) + "px");
  }
}
...
function getTocPageId() {
  var pathArray = ($(location).attr("pathname") + $(location).attr("href"))
    .replace(/\/$/, "")
    .split("/");
  var productDir = $(".toc_icon")
    .attr("id")
    .replace(/^toc\./, "");
...
function toggleImageAnimation() {
  ...
  if (imgElt.hasClass("dynamic-image")) {
    ...
    pathArray[pathArray.length - 1] =
      anm_prefix + fileName.split(".")[0] + anm_suffix;
...
function checkExpandAllLinkState(elt) {
  ...
  if (
    expandableParent.length === 0 ||
    expandableParent.find(".expandAllLink").length === 0
  ) {
    return;
  }
